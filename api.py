...
# Новые методы.
    ...
    def add_new_pet_with_incorrect_auth_key(self, auth_key: json, name: str, animal_type: str,
                    age: str, pet_photo: str) -> json:
        """Метод отправляет (постит) на сервер данные о добавляемом питомце с невалидным ключом"""
    ...
    def delete_pet_with_unvalid_auth_key(self, auth_key: json, pet_id: str) -> json:
        """Метод отправляет на сервер запрос на удаление питомца с невалидным ключом по указанному ID."""
